                    ...
                    <div class="card-body">
                        <form  method="POST" action="{{ route('Update_Site_Settings_New' , ['id' => $site_setting->id]) }}"  enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea type="text" class="form-control" id="nav_html" name="nav_html" rows="6" >
                                    {{ old('text', $site_setting->nav_html) }}
                                </textarea>
                            </div>
                            <div class="mb-4">
                                <label for="nav_css	" class="form-label">Enter Nav CSS</label>
                                <textarea type="text" class="form-control" id="nav_css	" name="nav_css" rows="6">
                                    {{ old('text', $site_setting->nav_css) }}
                                </textarea>
                            </div>
                            <div class="mb-4">
                                <label for="nav_project_data" class="form-label">Enter Nav Project Extra Data</label>
                                <textarea type="text" class="form-control" id="nav_project_data" name="nav_project_data" rows="6" >
                                    {{ old('text', $site_setting->nav_project_data) }}
                                </textarea>
                            </div>
                            <div class="mb-4">
                                <label for="footer_html" class="form-label">Enter Footer Html</label>
                                <textarea type="text" class="form-control" id="footer_html" name="footer_html" rows="6" >
