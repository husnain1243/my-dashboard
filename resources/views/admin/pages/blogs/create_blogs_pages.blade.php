            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow">
                    <div class="card-title text-center border-bottom">
                        <h2 class="p-3">Create new Blog</h2>
                        @include('includes.alert')
                    </div>
                    <div class="card-body">
                        <form  method="POST" action="{{ route('Blogs_Saver') }}"  enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn text-light main-bg">Create Blog</button>
                            </div>
                        </form>
                    </div>
                </div>
